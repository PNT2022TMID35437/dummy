================================================================================
                SmartFusion2 CoreUARTapb polled string transmit example
================================================================================

This example project demonstrates how to use the CoreUARTapb driver to transmit a
zero-terminated string in polled mode.
...
This example will continuously display a message on HyperTerminal.
